      ...
      <SectionContent className="relative isolate">
          ...
          <div className="absolute-center -z-10 ">
            <motion.div style={{
              ...
              <Planet size="md" color="teal" className="-translate-x-[500px] -translate-y-[20px] rotate-90"/>
            </motion.div>
          </div>
          <div className="absolute-center -z-10 ">
          <motion.div style={{
        ...
        <h2 className="text-gray-200 font-semibold text-3xl md:text-4xl lg:text-5xl text-center leading-tight max-w-xl mx-auto">Join the AI Revolution with  
          <span className="relative isolate ">
            <span> Sphereal</span>
            <span className="absolute top-full left-0 w-full -translate-y-1/2 h-4 
        ...
        <p className="text-center text-xl mt-8 max-w-2xl mx-auto">Experience the transformative power of AI with Sphereal, Boost your productivity and streamline your
